        ...
        <Row className="mt-4">
          ...
          <Col sm="12" className="my-3">
            <div className="rounded bg-bluelight p-4">
              ...
              <div><a className="text-white" href="https://www.who.int/news-room/q-a-detail/q-a-coronaviruses" target="_blank" rel="noopener noreferrer">https://www.who.int/news-room/q-a-detail/q-a-coronaviruses</a></div>
              <div><a className="text-white mb-4" href="https://www.cdc.gov/coronavirus/2019-ncov/faq.html" target="_blank" rel="noopener noreferrer">https://www.cdc.gov/coronavirus/2019-ncov/faq.html</a></div>
