            ...
            <div className="my-2 text-white my-4 ">
              ...
              <NoTransWrapper>
                <Trans i18nKey="join_askingAllLikeMinded">
                  ...
                  <a className={"text-white"} rel="noopener noreferrer" target="_blank" href="https://fusemachines.com">
                    Fusemachines
                  </a>{" "}
                  and asking all like minded citizens of Nepal to join in this effort to create an Open Source platform
                  to serve as a reliable source of information about Covid-19 in Nepal.
                  <br />
        ...
        <Row className="py-5 mt-5 bg-success justify-content-center" id="volunteer-with-us">
          ...
          <Col lg="3" md="5">
            <div className="">
              ...
              <a
                href="https://bit.ly/collectnepalhospitaldata"
                target="_blank"
                rel="noopener noreferrer"
