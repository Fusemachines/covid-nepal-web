    ...
    <>
      ...
      <Row className="mb-3">
        <Col xs="6">
          ...
          <div className="h3 m-0 font-weight-bold  d-inline-block">
            <TranslateNumber
              originalValue={covidCasesNepalCounts ? setCommas(2458565) : "-"}
              language={language}
            />
          </div>
      ...
      <Row className="mb-3">
        <Col xs="6">
          ...
          <div className="h3 m-0 font-weight-bold  d-inline-block">
            <TranslateNumber
              originalValue={covidCasesNepalCounts ? setCommas(34117) : "-"}
              language={language}
            />
          </div>
          {/* <TextCaption type={'success'} value={'0.10'} /> */}
      ...
      <Row className="mb-3">
        <Col xs="6">
          ...
          <div className="h3 m-0 font-weight-bold d-inline-block ">
            <TranslateNumber
              originalValue={covidCasesNepalCounts ? setCommas(280167) : "-"}
              language={language}
            />
          </div>
      ...
      <Row className="mb-2">
        <Col xs="6">
          ...
          <div className="h3 m-0 font-weight-bold d-inline-block">
            <TranslateNumber
              originalValue={covidCasesNepalCounts ? setCommas(3246) : "-"}
              language={language}
            />
          </div>
